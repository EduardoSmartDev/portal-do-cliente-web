...
export default function ProjetoPage({ projeto, user }: ProjetoPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Header
        ...
        subtitle={`Projeto: ${projetoData.codigo}`}
        user={user}
      ></Header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              ...
              <div>{getStatusIcon(projetoData.status)}</div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {projetoData.areaConstruida}m²
                </p>
              </div>
              <Home className="w-8 h-8 text-blue-500" />
            </div>
            <p className="mt-2 text-sm text-gray-500">
              {projetoData.tipologia}
            </p>
          </div>
                  ...
                  {projetoData.etapas?.map((etapa, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-start space-x-3 flex-1">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
                              <span>
                                Previsão: {formatDate(etapa.dataPrevisao)}
                              </span>
                              {etapa.responsavel && (
                      ...
                      <div className="mt-3 bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full transition-all ${getEtapaStatusColor(
                            etapa.status
                          )}`}
                  ...
                  {projetoData.endereco && (
                    <>
                      <p className="text-sm font-medium text-gray-900 mt-1">
                        {projetoData.endereco.logradouro},{" "}
                        {projetoData.endereco.numero}
                      </p>
                      <p className="text-sm text-gray-600">
                        {projetoData.endereco.bairro},{" "}
                        {projetoData.endereco.cidade} -{" "}
                        {projetoData.endereco.estado}
                      </p>
                    </>
                  )}
                </div>
